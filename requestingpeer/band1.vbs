...
strComputer = "."
    ...
    objConn.Open "Provider=Microsoft.Jet.OLEDB.4.0; Data Source=band.mdb"




Set objWMIService = GetObject("winmgmts:\\" & strComputer & "\root\cimv2")
Set colItems = objWMIService.ExecQuery("Select * from Win32_PerfRawData_Tcpip_NetworkInterface where Name='Broadcom 802.11g Network Adapter'",,48)
...
strSQL = "INSERT INTO bandwidth VALUES("&objItem.BytesSentPersec/1000&");"
